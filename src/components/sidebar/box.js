...
const box = () => {
    return (
        <div className='bg-[#FFFCEF] min-h-[100vh] py-[23px] px-5 rounded-[13px] flex flex-col '>
            <h2 className='font-bold mb-4 mx-auto'>شارژ باقیمانده سیم کارت</h2>
            ...
            <div className='bg-white w-[288px] h-[104px] rounded-[8px] mt-40 flex items-center justify-between px-3'>
                <div className='w-[160px] h-[54px]'>
                    <img src={FooterText}/>
                </div>
